...
#define KNN_MATCH_RATIO 1.0f //작을수록 KNN 매칭 정확도 향상(단, 매칭수가 줄어듦)
...
void VideoCalibrationInfo::undistortAndDrawingMarkerCube(String MarkerImage, String MarkerVideo, int solvePnpRansacFlag) {
	...
	vector<Point3f> CubePoints;
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2, CUBE_Y - MARKER_CUBE / 2, 0.));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2 + MARKER_CUBE, CUBE_Y - MARKER_CUBE / 2, 0.));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2 + MARKER_CUBE, CUBE_Y - MARKER_CUBE / 2 + MARKER_CUBE, 0.));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2, CUBE_Y - MARKER_CUBE / 2 + MARKER_CUBE, 0.));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2, CUBE_Y - MARKER_CUBE / 2, -MARKER_CUBE));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2 + MARKER_CUBE, CUBE_Y - MARKER_CUBE / 2, -MARKER_CUBE));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2 + MARKER_CUBE, CUBE_Y - MARKER_CUBE / 2 + MARKER_CUBE, -MARKER_CUBE));
	CubePoints.push_back(Point3f(CUBE_X - MARKER_CUBE / 2, CUBE_Y - MARKER_CUBE / 2 + MARKER_CUBE, -MARKER_CUBE));
	...
	for (int i = 0; i < _nframe; i++) {
		...
		cv::solvePnPRansac(ObjectCorners, ImageCorners, CameraMatrix, Mat(), R, T, false, 100, 2.f, 0.989999999999999, inliers, solvePnpRansacFlag);
